...
class TakeMovieViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
        ...
        @IBOutlet weak var previewView: TakeMovieView!
...
//            var bounds: CGRect = self.previewView.bounds
...
//            self.previewView.layer.bounds = bounds
//            self.previewView.layer.position=CGPointMake(CGRectGetMidX(bounds), CGRectGetMidY(bounds));


            
//            self.previewView.frame  = self.view.frame
//            self.previewView.videoGravity = AVLayerVideoGravityResizeAspectFill;
//            self.previewView.bounds = self.view.layer.bounds
            ...
            dispatch_async(sessionQueue, {
                ...
                var videoDevice: AVCaptureDevice! = TakeMovieViewController.deviceWithMediaType(AVMediaTypeVideo, preferringPosition: AVCaptureDevicePosition.Back)
...
//                }
                ...
                if session.canAddOutput(movieFileOutput){
                    ...
                    let stab: Bool = connection!.supportsVideoStabilization
                    if stab  {
        ...
        override func viewWillAppear(animated: Bool) {
            dispatch_async(self.sessionQueue, {
                ...
                self.runtimeErrorHandlingObserver = NSNotificationCenter.defaultCenter().addObserverForName(AVCaptureSessionRuntimeErrorNotification, object: self.session, queue: nil, usingBlock: {
                    ...
                    var strongSelf: TakeMovieViewController = weakSelf!
...
//                        self.cameraButton.enabled = true
        ...
        func captureOutput(captureOutput: AVCaptureFileOutput!, didFinishRecordingToOutputFileAtURL outputFileURL: NSURL!, fromConnections connections: [AnyObject]!, error: NSError!) {
            ...
            println("takeMovie:", outputFileURL)
        ...
        @IBAction func toggleMovieRecord(sender: AnyObject) {
            ...
            dispatch_async(self.sessionQueue, {
                if !self.movieFileOutput!.recording{
                    ...
                    println("movieFileOutputOrientation: \(self.movieFileOutput!.connectionWithMediaType(AVMediaTypeVideo).videoOrientation) ")
                    ...
                    println("movieFileOutputOrientation after: \(self.movieFileOutput!.connectionWithMediaType(AVMediaTypeVideo).videoOrientation) ")
                    
                    // Turning OFF flash for video recording
                    TakeMovieViewController.setFlashMode(AVCaptureFlashMode.Off, device: self.videoDeviceInput!.device)
        ...
        @IBAction func snapStillImage(sender: AnyObject) {
            ...
            dispatch_async(self.sessionQueue, {
                ...
                TakeMovieViewController.setFlashMode(AVCaptureFlashMode.Auto, device: self.videoDeviceInput!.device)
        ...
        @IBAction func changeCamera(sender: AnyObject) {
            ...
            dispatch_async(self.sessionQueue, {
                ...
                var device:AVCaptureDevice = TakeMovieViewController.deviceWithMediaType(AVMediaTypeVideo, preferringPosition: preferredPosition)
                ...
                if self.session!.canAddInput(videoDeviceInput){
                    ...
                    TakeMovieViewController.setFlashMode(AVCaptureFlashMode.Auto, device: device)
